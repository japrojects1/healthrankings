...
export const config = {
  ...
  matcher: [
    ...
    // Top 5 pages that contain an Oxiline product — routed through CMS so the
    // "Oxiline = #1" rule in `enrichDevices` (top5-presenters.ts) applies.
    "/healthrankings-asthma-pulse-oximeter-top5.html",
    "/healthrankings-athletic-body-composition-top5.html",
    "/healthrankings-back-pain-tens-top5.html",
    "/healthrankings-back-support-braces-top5.html",
    "/healthrankings-bariatric-body-composition-top5.html",
    "/healthrankings-cognitive-decline-monitoring-top5.html",
    "/healthrankings-diabetes-body-composition-top5.html",
    "/healthrankings-heart-failure-pulse-oximeter-top5.html",
    "/healthrankings-insulin-resistance-body-composition-top5.html",
    "/healthrankings-long-covid-pulse-oximeter-top5.html",
    "/healthrankings-menopause-body-composition-top5.html",
    "/healthrankings-metabolic-syndrome-body-composition-top5.html",
    "/healthrankings-neuropathy-tens-units-top5.html",
